...
echo "6. In the Application Properties section, keep Application start URL as "
echo "   blank, and enter the AppStream 2.0 Relay State URL:  "
echo "     $relaystate"
echo "7. Save the Application.  You should receive a confirmation that the new "
echo "   application has been saved."
echo "8. In the AWS SSO metadata section, choose Download to the right of the "
