...
# PowerShell DSC Configuration Block for Domain Controller
Configuration ConfigDC {
    ...
    Node 'localhost' {
        ...
        # Setting DNS Server on Primary Interface to point to ExternalDomainControllerIp
        DnsServerAddress DnsServerAddress {
            Address = $ExternalDomainControllerIp
            InterfaceAlias = 'Primary'
            AddressFamily  = 'IPv4'
            DependsOn = '[NetAdapterName]RenameNetAdapterPrimary'
        }
